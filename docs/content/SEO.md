...
|--------|-------|-------------|--------|
| トップLP | `イチオシ採用｜会社の魅力を、人にもAIにも届けるコンテンツ採用` | イチオシ採用は、1回の取材から採用漫画・アニメ・記事・掲載ページを制作し、求人広告から面接前、AI検索まで届けるコンテンツ採用サービスです。条件ではなく魅力を理解した応募へ。まずは無料診断から。（2026-09-23） | `TBD` |
| 導入事例 | `導入事例｜イチオシ採用` | 採用支援事例。労働条件は変えずに求人原稿と運用の改善だけで月数名の応募がひと月で82名に（飲食・清掃中心） | `TBD` |
| 料金プラン | `料金プラン｜イチオシ採用` | イチオシ採用の料金プラン。制作と配給の月額プランは、ライト19.8万円・スタンダード34.8万円・フル58.9万円の3つ。すべてのプランに制作・配給・レポートが含まれ、広告費・応募課金は別建てです。（2026-09-25 に旧4プラン名の description から差し替え） | `TBD` |

...
イチオシ採用はコンテンツエックス（Contents X / BizManga を運営）の新サービス。**「伝わる設計」**が事業の軸。デザインは新規だが、ブランドボイス・デバイス品質・エンジニアリング規約は兄弟事業から継承する。
...
- 新サービス: **イチオシ採用**（ichioshi.contentsx.jp / 採用LP・デザイン新規）
